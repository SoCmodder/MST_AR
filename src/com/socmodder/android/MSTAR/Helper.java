...
public class Helper extends OrmLiteSqliteOpenHelper
{
    ...
    public void createBuildings(){
        ...
        try{
            ...
            Building b = new Building("Computer Science", desc, -91.774447f, 37.955555f, 1165);
            bDao.create(b);

            desc = "Books, books, and more books! Sometimes people sleep here when they're studying, too!";
            b = new Building("Library", desc, -91.77332205172004f, 37.95543497056854f, 1165);
            bDao.create(b);

            desc = "Humanities and Social Sciences";
            b = new Building("HSS", desc, -91.77424371242523f, 37.95531846920783f, 1165);
            bDao.create(b);

            desc = "Engineering Management Building...";
            b = new Building("Engineering Managment", desc, -91.775128f, 37.955475f, 1165);
            bDao.create(b);

            desc = "Chemistry!";
            b = new Building("Shrenk Hall", desc, -91.774091f, 37.952875f, 1165);
            bDao.create(b);

            desc = "The bookstore is located here. You can also come here for food!";
            b = new Building("Havener Center", desc, -91.77592959113267f, 37.95476631091687f, 1165);
            bDao.create(b);

            desc = "Inter-Disciplenary Engineering";
            b = new Building("IDE", desc, -91.771995f, 37.953963f, 1165);
            bDao.create(b);

            desc = "There are alot of labs and IST classes here...";
            b = new Building("Centenial Hall", desc, -91.773116f, 37.953083f, 1165);
            bDao.create(b);

            desc = "Aerospace and Mechanical Engineering";
            b = new Building("Toomey Hall", desc, -91.774025f, 37.954098f, 1165);
            bDao.create(b);

            desc = "Civil Engineering";
            b = new Building("Butler-Carlton Hall", desc, -91.77369385505148f, 37.95520863546415f, 1165);
            bDao.create(b);

            desc = "This is the double E building!";
            b = new Building("Electrical Engineering", desc, -91.772375f, 37.956401f, 1165);
            bDao.create(b);

            desc = "This is where you get to take the most fun physics classes ever!";
            b = new Building("Physics", desc, -91.77318392752757f, 37.95486703799107f, 1165);
            bDao.create(b);

            desc = "Mining Engineering is here!";
            b = new Building("McNutt Hall", desc, -91.775837f, 37.955635f, 1165);
            bDao.create(b);

            desc = "el parker";
            b = new Building("Parker Hall", desc,  -91.77309036254883f, 37.95438367892742f, 1165);
            bDao.create(b);

            desc = "Norwood";
            b = new Building("Norwood Hall", desc, -91.77281677722931f, 37.953643451939854f, 1165);
            bDao.create(b);

            desc = "Fulton Hall";
            b = new Building("Fulton Hall", desc, -91.77301526069641f, 37.95493778681906f, 1165);
            bDao.create(b);
