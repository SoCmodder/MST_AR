...
{
	private String key = "BRKlXP3V5iv6RI/wrBX5xEKK8kDFdXVGi29IQOdNyleals3BnO7iLIbhtaFWOnVp1L2v1CM9LiiCUAlnyRuVQPNpgLijVQB" +
            "0tBUhxN+4Zcle8iGv0MRy/+ltsLTd+LecLZ70bd/Eoo2DG0aaqJMXwJuZzHRhOij1HdTB9NHWWQRTYWx0ZWRfX6uL+" +
            "WjpAeMNJsgruSkyYiJ927jL2jy1V4WaltO4j2tzqk00dBslgtIF87dnBCjDI2uMK/RIZS0S9e4wAd8hTF0SacWJOtrj/ESwV8P" +
            "obCvOGr6yBqVzxGQsM7dLCf3mqXJl2w2B7s1xdrcyXvT+u/AQzWfB6eWycKAQtEatiz4G6+Z+8sKTGN/jgcCnoLlYSRHJ" +
            "+H2ADzkeZvisBWxWLaFoNs9ik5ejqxtOrUFZYWatTQ98k3ITgQcBa/GOAlUFoYJPRWDTmlwffiPVQO/Kx4Ayv80dSk9n5" +
            "Siqe+t6P7B/h/j8muhsbEga+XUNXR2S4ETgcSdjdvF9AZXZoBTvkPJhFFJOwpaiZjZqV5o18qrwtVm0jGDvtWeGu818jyW" +
            "wd7g1g8Og517b/tpWahsdpKHFpY0skKgnQuHtMk81rQxMMmq5zaA6U5GjQceJdAEJ7mjuPo6NC7u+IIe93l1+XwiyHjIM" +
            "egUAkQ==";
    ...
    public void onLocationChanged(Location location) {
        if(this.architectView != null){
            Toast.makeText(this.getApplicationContext(), String.valueOf(location.getLatitude()), Toast.LENGTH_LONG).show();
            Toast.makeText(this.getApplicationContext(), String.valueOf(location.getLongitude()), Toast.LENGTH_LONG).show();
            this.architectView.setLocation(location.getLatitude(), location.getLongitude(), location.getAccuracy());
        }
    }
